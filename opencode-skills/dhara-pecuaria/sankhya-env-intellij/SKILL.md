...
- Project SDK: `C:\dharatecnologia\tools\jdk8\jdk8u492-b09`.
- Gradle JVM: o mesmo JDK 8.
- Gradle user home: `C:\dharatecnologia\tools\gradle-cache`.
- Variaveis:
  - `JAVA_HOME=C:\dharatecnologia\tools\jdk8\jdk8u492-b09`
  - `GRADLE_USER_HOME=C:\dharatecnologia\tools\gradle-cache`
