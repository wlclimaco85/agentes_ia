$paths = [ordered]@{
    ...
    "Gradle" = "C:\dharatecnologia\tools\gradle-7.6.4\bin\gradle.bat"
...
Write-Host "`$env:JAVA_HOME='C:\dharatecnologia\tools\jdk8\jdk8u492-b09'"
Write-Host "`$env:GRADLE_USER_HOME='C:\dharatecnologia\tools\gradle-cache'"
