...
5. Consultar exemplos locais antes de inventar padroes: `C:\sk-java\git\sankhyaw`, `C:\dharatecnologia\hello-world-addon`, docs locais em `C:\dharatecnologia\docs`.
...
- Exemplo funcional: `C:\dharatecnologia\hello-world-addon`.
- Fontes Sankhya para pesquisa: `C:\sk-java\git\sankhyaw`.
- JDK 8 local: `C:\dharatecnologia\tools\jdk8\jdk8u492-b09`.
- Gradle local: `C:\dharatecnologia\tools\gradle-7.6.4`.
- Cache Gradle local: `C:\dharatecnologia\tools\gradle-cache`.
